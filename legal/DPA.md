...
New Zealand Privacy Act 2020, the Australian Privacy Act 1988 (Cth) and
Australian Privacy Principles, the California Consumer Privacy Act as
...
or in the applicable Data Protection Laws. In particular:

- **"Customer Personal Data"** means personal data that is contained in
  Customer's local device storage or processed by Customer through the
  Service.
...
- access controls on administrative systems (MFA, least-privilege, logging);
- encryption in transit (TLS) for Customer-facing systems;
- isolation of environments;
- secure software-development practices (peer review, dependency scanning);
- vulnerability disclosure per `docs/SECURITY.md`;
- regular review of sub-processors and service providers.

Measures within the Service itself are documented in `docs/SECURITY.md` and
in the Privacy Policy (see "Plaintext-at-rest notice"). Customer is
responsible for configuring devices, operating systems, account controls,
and third-party providers to meet any additional security requirements
...
by law, on at least thirty (30) days' prior written notice, during normal
business hours, and at Customer's cost.
...
liability in the Agreement. Nothing in this DPA limits or excludes
liability for breaches of Data Protection Laws that cannot be limited by
contract.
...
This DPA is governed by the laws of New Zealand, without prejudice to the
application of any mandatory Data Protection Laws.

---

**EU / UK / Swiss Appendix — Standard Contractual Clauses**

Where required, the EU Standard Contractual Clauses (Commission
Implementing Decision (EU) 2021/914, Module 2 or Module 3 as applicable)
and, for UK transfers, the UK International Data Transfer Addendum (IDTA)
are deemed incorporated by reference. Annex I and Annex II are completed
by reference to the Agreement and `legal/SUBPROCESSORS.md`. Annex III
(sub-processors) is `legal/SUBPROCESSORS.md`. The Supervisory Authority
is the authority with jurisdiction over Customer's establishment.

For the **Swiss FADP**, references to GDPR are read to include the FADP,
the Swiss Federal Data Protection and Information Commissioner is the
competent authority, and Swiss law governs where mandatory.
