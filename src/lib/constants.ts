...
export const VOICE_COMMANDS = [
  ...
  { command: "new section", action: "legal_new_section", description: "Insert a section break" },
  { command: "new clause", action: "legal_new_clause", description: "Insert a clause break" },
  { command: "number one", action: "legal_item_1", description: "Insert numbered list item 1." },
  { command: "number two", action: "legal_item_2", description: "Insert numbered list item 2." },
  { command: "number three", action: "legal_item_3", description: "Insert numbered list item 3." },
  { command: "number four", action: "legal_item_4", description: "Insert numbered list item 4." },
  { command: "number five", action: "legal_item_5", description: "Insert numbered list item 5." },
...
export const STT_ENGINES = {
  ...
  whisper_local: {
    ...
    description: "On-device transcription — audio never leaves your machine",
    icon: "shield",
  },
} as const;
