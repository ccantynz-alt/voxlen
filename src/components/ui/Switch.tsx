  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          "relative inline-flex shrink-0 rounded-full transition-colors duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-vox-500 focus-visible:ring-offset-2 focus-visible:ring-offset-surface-0",
          {
            "h-5 w-9": size === "sm",
            "h-6 w-11": size === "md",
            "bg-vox-600": checked,
