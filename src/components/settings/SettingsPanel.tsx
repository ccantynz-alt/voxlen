  ...
  return (
    <div className="space-y-6 max-w-lg">
      <SectionHeader
        ...
        description="These shortcuts work from any application, even when Vox is minimized."
      />
    ...
    <div className="space-y-6 max-w-lg">
        ...
        <Select
          ...
          options={[
            ...
            },
            {
              value: "buffer",
              label: "Buffer Only",
              description: "Text stays in Vox - copy manually",
            },
          ]}
        />
      </SettingRow>
      ...
      <SettingRow>
        <Switch
          ...
          description="Launch Vox minimized to the system tray"
      ...
      <SettingRow>
        <Switch
          ...
          description="Keep Vox running in the system tray when closed"
      ...
      <SettingRow>
        <Switch
          ...
          description="Automatically start Vox when you log in"
...
function PrivacySettings() {
  ...
  return (
    <div className="space-y-6 max-w-lg">
      <SectionHeader
        title="Privacy"
        description="Your data, your control. Vox can work fully offline with local models."
      />
      ...
      <SettingRow>
        <Switch
          ...
          description="Help us improve Vox with anonymous usage data"
